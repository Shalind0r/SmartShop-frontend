...
import Communication from 'entities/Communication/Communication';
			...
			<div className={`container`}>
				<div className={classes.footer__container}>
					<div className={classes.footer__leftSide}>
						<h4
							className={`${classes.footer__leftTitle} typography--h4`}
						>
							Підписка на розсилку новин/статей
						</h4>
						<p
							className={`${classes.label} typography--base-extended`}
						>
							Підпишіться на останні оновлення та дізнавайтеся про
							новинки та спеціальні пропозиції першими
						</p>
						<SubscribeForm className={classes.footer__form} />
						<Communication
							className={classes.footer__communication}
						>
							<NumberImg
						...
						<p
							className={`${classes.copyright}typography typography--small`}
						>
							<span className={classes.copyright__item}>
								&copy;
							</span>
						...
						>
							<div className={classes.payments}>
								<div className={classes.payments__system}>
									<MasterCardLogo
										className={classes.payments__item}
									/>
									<VisaLogo
										className={classes.payments__item}
									/>
